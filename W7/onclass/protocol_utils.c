...
void server_handle_message(application_msg_t *in_msg, application_msg_t *out_msg, Llist_s *client_list, pid_t pid_client) {
        ...
        case MSG_LOGIN: {
            ...
            if (in_msg->len > 0) {
                ...
                if(client_list != NULL && strcmp(searchUsernameList(client_list, in_msg->value).username, "") != 0){
                    ...
                    printf("[SERVER]|[CHILD %d] Gửi phản hồi: CONFIRM cho %s \n", pid_client, logged_in_client);
